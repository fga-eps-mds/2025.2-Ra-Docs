...
O sistema é executado inteiramente em máquinas locais, por adotarmos a estratégia de contrução dos microserviços com monorepositório, e uma arquitetura cliente-servidor.
...
A seleção de tecnologias foi baseada na simplicidade, produtividade e no objetivo de simular uma arquitetura de microserviços em ambiente local.
